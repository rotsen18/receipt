...
GOOGLE_KEY_NAME = env.str('GOOGLE_DRIVE_STORAGE_JSON_KEY_FILE', None)
GOOGLE_DRIVE_STORAGE_JSON_KEY_FILE = os.path.join(BASE_DIR, GOOGLE_KEY_NAME) if GOOGLE_KEY_NAME else None
