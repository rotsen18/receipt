...
receipt_source_create_button_name = 'Нове джерело'
receipt_source_list_button_name = 'Джерела'
receipt_source_text = 'Встав текст, посилання чи іншу замітку щоб пізніше створити рецепт:'
receipt_source_saved_text = 'Джерело збережено'
