...
recalculate_portion_question = 'Базовий рецепт був розрахований на {previous_portions} порцій\nНа скільки порцій перерахувати рецепт?'
recalculate_result_title = 'На {new_portions} порцій рецепт буде виглядати так:'
